...
public class PermissionActivity extends AppCompatActivity {
    ...
    public static void request(Activity activity, String permissionStr){
        // Here, thisActivity is the current activity
...
//                Toast.makeText(thisActivity, "请求权限", Toast.LENGTH_SHORT).show();
    ...
    public static void  onRequestPermission(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults){
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_CONTACTS: {
                // If request is cancelled, the result arrays are empty.
                if (grantResults.length > 0
